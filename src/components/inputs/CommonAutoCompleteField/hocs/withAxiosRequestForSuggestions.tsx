...
import type {
  TAutoCompleteOption,
  TAutocompleteQueryFailReason,
  TCommonAutoCompleteFieldProps,
} from '../_types';
...
function withAxiosRequestForSuggestions<T>(
  ...
  return (WrappedComponent: React.FC<TCommonAutoCompleteFieldProps>) =>
    (props: TCommonAutoCompleteFieldProps) => {
      const {
        loading: unusedLoading,
        options: unusedOptions,
        onQuery: unusedOnquery,
        onChange,
        ...otherProps
      } = props;
