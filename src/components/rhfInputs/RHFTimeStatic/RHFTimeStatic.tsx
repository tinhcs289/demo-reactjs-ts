import CommonTimeStaticField from '@/components/inputs/CommonTimeStaticField';
...
import type { RHFTimeStaticProps } from './_types';
export default function RHFTimeStatic(props: RHFTimeStaticProps) {
