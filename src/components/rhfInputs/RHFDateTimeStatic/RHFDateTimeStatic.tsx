import CommonDateTimeStaticField from '@/components/inputs/CommonDateTimeStaticField';
...
import type { RHFDateTimeStaticProps } from './_types';
export default function RHFDateTimeStatic(props: RHFDateTimeStaticProps) {
