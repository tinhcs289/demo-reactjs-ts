...
import type { CommonTableActionsPopoverProps, ItemMenuActionConfig } from './_types';
export default function CommonTableActionsPopover<RowData extends AnyObject>(
  props: CommonTableActionsPopoverProps<RowData>
) {
