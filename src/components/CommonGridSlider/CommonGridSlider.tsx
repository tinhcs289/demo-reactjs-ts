...
import { AnyObject, MuiBreakPoint } from '@/types';
...
import type { CommonGridSliderProps } from './_types';
const HEIGHT = 200;
...
function useSlidesPerViewByScreen(slidesPerView?: number | 'auto' | Partial<Record<MuiBreakPoint, number>>) {
...
export default function CommonGridSlider<T extends AnyObject>(props: CommonGridSliderProps<T>) {
  const {
    data,
    boxHeight,
    rows,
