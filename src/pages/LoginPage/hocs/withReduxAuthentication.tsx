...
export default function withReduxAuthentication(WrappedComponent: ComponentType<LoginPageProps>) {
  return function LoginPageWithReduxAuthentication(props: LoginPageProps) {
