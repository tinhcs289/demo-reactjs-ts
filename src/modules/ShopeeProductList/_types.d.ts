export type TShopeeCategoryItem = {
  catid?: number;
  parent_catid?: number;
  name?: string;
  display_name?: string;
  ...
  children?: TShopeeCategoryItem[];
  [x: string]: any;
};
export type TShopeeProductItem = {
  itemid: number;
  key: `item:${number}`;
  item_status?: string;
  item_type?: number;
...
export type TShopeePromoBrandItem = {
  shopid: number;
  image?: string;
  promo_text?: string;
...
export type TShopeeProductItemImageFlag = {
  id: number;
...
export type TShopeeProductItemImageOverlay = TShopeeProductItemImageFlag & {
  campaign_image?: string;
  campaign_image_height?: number;
  campaign_image_width?: number;
};

export type TShopeeProductItemPromotionLabel = TShopeeProductItemImageFlag & {
  displayed_texts?: {
    lang?: string;
    text?: string;
  }[];
...
export type TShopeeElementSet = {
  image_flag?: TShopeeProductItemImageFlag[];
  overlay_image?: TShopeeProductItemImageOverlay[];
  promotion_label?: TShopeeProductItemPromotionLabel[];
};
