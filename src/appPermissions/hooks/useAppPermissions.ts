...
/**
 * check the ability to use a `function|view|component` by a `PermissionClause` from the object `FEATURE` in `@/appPermissions/constants`
 ...
 * @example
   import { FEATURE, useAppPermissions } from '@/appPermissions';
   .....
