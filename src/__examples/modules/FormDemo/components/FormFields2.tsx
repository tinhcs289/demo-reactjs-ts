...
import RHFCheckGroup, { CheckGroupOption } from '@/components/rhfInputs/RHFCheckGroup';
...
import RHFRadioGroup, { RadioGroupOption } from '@/components/rhfInputs/RHFRadioGroup';
import RHFSelect, { AutoCompleteOption } from '@/components/rhfInputs/RHFSelect';
...
const optionsCheck: CheckGroupOption[] = consecutiveNumbers(5, 1).map((i) => ({
  label: `${i}. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`,
  value: `${i}`,
}));
const optionRadio: RadioGroupOption[] = consecutiveNumbers(5, 1).map((i) => ({
  label: `${LABEL1} ${i}`,
  value: `${i}`,
}));
const options: AutoCompleteOption[] = consecutiveNumbers(20, 1).map((i) => ({
  label: `lựa chọn ${i}`,
  value: `${i}`,
}));
